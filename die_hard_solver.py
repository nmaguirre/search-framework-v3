from problems import DieHardProblem, WaterJugState

# Create the problem
problem = DieHardProblem(jug1_capacity=5, jug2_capacity=3, target=4)
    
print("=" * 70)
print("DIE HARD WATER JUG PROBLEM")
print(f"Jugs: {problem.jug1_cap}-gallon and {problem.jug2_cap}-gallon")
print(f"Target: {problem.target} gallons")
print("=" * 70)
